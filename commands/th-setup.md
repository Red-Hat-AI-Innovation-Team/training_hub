---
description: "Guided first-run configuration for LLM training"
argument-hint: ""
allowed-tools: ["Bash(${CLAUDE_PLUGIN_ROOT}/scripts/th_detect.sh:*)"]
---

# training-hub Setup

You are helping the user configure LLM training for their workflows.
...
If `library=missing`:
- Ask the user: "training_hub isn't installed. I can install it for you — want me to proceed?"
...
- Ask about extras:
  - CUDA support: `training-hub[cuda]` (flash-attn, bitsandbytes)
  - LoRA support: `training-hub[lora]` (unsloth, trl)
  - GRPO support: `training-hub[grpo]` (openpipe-art, verl)
...
If the user runs `/th-setup` again and a config already exists, ask: "You already have a configuration. Do you want to update it or start fresh?"
